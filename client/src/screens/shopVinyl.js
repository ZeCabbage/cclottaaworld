  ...
  render() {
    ...
    container.innerHTML = `
      <div class="screen-enter" style="min-height:100%;background:var(--color-bg-surface);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:var(--space-2xl);">
        ...
        <h2 class="pixel-text" style="font-size:var(--text-sm);color:var(--neon-cyan);margin-bottom:var(--space-md);">Vinyl Store</h2>
...
screenRegistry.register('shopVinyl', shopVinylScreen, { title: 'Vinyl Store', path: 'shopVinyl', icon: '💿', category: 'shop' });
